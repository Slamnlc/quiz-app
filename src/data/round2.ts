...
export const roundTwoItems: RoundTwoItem[] = [
  ...
  },
  {
    id: 4,
    puzzle: ["👁", "🐯", "🥊"],
    hintLines: ["Пісня про боротьбу та перемогу"],
  ...
  },
  {
    id: 10,
    puzzle: ["🪖", "💡", "🪖", "🕊"],
    hintLines: ["В 22 році її автор переспівав українською"],
  ...
  },
  {
    id: 12,
    puzzle: ["👑", "🌙", "💃"],
    hintLines: ["Її не пускають на Євробачення"],
